...
namespace WebApi.Infrastructure.Migrations
{
    ...
    [Migration("20250902141622_UpdateCheckConstraintSyntaxV2")]
    partial class UpdateCheckConstraintSyntaxV2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApi.Domain.Entities.BusinessSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WebApi.Domain.Entities.ImpersonationLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("PlatformStaffId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PlatformStaffId", "PerformedAt");
            ...
            modelBuilder.Entity("WebApi.Domain.Entities.PasswordReset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("StaffId", "TokenHash")
                        .IsUnique();

                    b.ToTable("PasswordResets");
                });

            modelBuilder.Entity("WebApi.Domain.Entities.PaymentEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WebApi.Domain.Entities.PaymentProviderConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("SecretKeyEnc")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("WebhookSecretEnc")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("WebApi.Domain.Entities.SmtpConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WebApi.Domain.Entities.SubscriptionPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("PricePerBranch")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("WebApi.Domain.Entities.SubscriptionUsage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WebApi.Domain.Entities.SupportTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WebApi.Domain.Entities.UserDevice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WebApi.Domain.Entities.BusinessSubscription", b =>
                {
                    ...
                    b.HasOne("WebApi.Domain.Entities.SubscriptionPlan", "Plan")
                        .WithMany()
            ...
            modelBuilder.Entity("WebApi.Domain.Entities.SupportTicket", b =>
                {
                    ...
                    b.HasOne("WebApi.Domain.Entities.Staff", "CreatedByStaff")
                        .WithMany()
